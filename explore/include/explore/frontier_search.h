...
protected:
  ...
  std::vector<Frontier> enhanceCoverageAroundRobot(const std::vector<Frontier>& frontiers,
                                                                 const geometry_msgs::msg::Point& robot_position);
                                                              
  std::vector<Frontier> prioritizeFrontiersNearPath(const std::vector<Frontier>& frontiers,
                                                                  const geometry_msgs::msg::Point& robot_position);

  double calculateDistanceToPath(const geometry_msgs::msg::Point& frontier,
                                               const geometry_msgs::msg::Point& robot_position);
